...
public class NewsTabActivity extends AppCompatActivity implements BackgroundJobClient {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Methods.showPopup(NewsTabActivity.this);
            return true;
        } else if (id == R.id.cme) {
            Intent intent = new Intent(NewsTabActivity.this, CmeLandingActivity.class);
            startActivity(intent);
        } else if (id == R.id.refrence) {
            Intent intent = new Intent(NewsTabActivity.this, ReferenceTabActivity.class);
            startActivity(intent);
        } else if (id == R.id.converse) {
            Intent intent = new Intent(NewsTabActivity.this, UserActivity.class);
            startActivity(intent);
        }
