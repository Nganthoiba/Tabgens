...
public class NewsFlipperActivity extends AppCompatActivity implements BackgroundJobClient, FlipAdapter.Callback, FlipView.OnFlipListener, FlipView.OnOverFlipListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        token_id = sp.getTokenPreference(NewsFlipperActivity.this);
    ...
    private void getCmeArticle() {
        ...
        NetworkRequest.Builder builder = new NetworkRequest.Builder(NetworkRequest.MethodType.GET, ConstantValues.NEWS_FLIPPER_ITEM + "" + tab_id + "&" + "token=" + token_id, ConstantValues.NEWS_ARTICLE_RESPONSE);
