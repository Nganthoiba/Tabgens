...
//launching activity of application
...
//        54.169.129.117
        ...
        //click listener for sign in in application
    ...
    //validtion for checking user name and password are correct or not and internet is working or not
                          ...
                          /*  Intent intent = new Intent(getApplicationContext(), RegistrationIntentService.class);
                            ...
                            switch (jObj.getString("roles")) {
                                ...
                                default:
                                    ...
                                    Methods.showSnackbar("You have sucessfully login", (Activity) context);
                                    startActivity(intent);
                                    finish();
                                    break;
