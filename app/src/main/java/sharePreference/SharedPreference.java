 ...
 */
//store data of entire application behave like session in web
public class SharedPreference {
    ...
    /*********************************************************************************/
    public void saveFcmToken(Context context, String text) {
        SharedPreferences sharedPreferences;
        SharedPreferences.Editor editor;
        sharedPreferences = context.getSharedPreferences(FCM_KEY, Context.MODE_PRIVATE);
        editor = sharedPreferences.edit();
        editor.putString(FCM_KEY, text);
        editor.commit();
    }
    ...
    public String getFcmToken(Context context) {
        ...
        SharedPreferences sharedPreferences;
        sharedPreferences = context.getSharedPreferences(FCM_KEY, Context.MODE_PRIVATE);
        text = sharedPreferences.getString(FCM_KEY, null);
        return text;
    }
