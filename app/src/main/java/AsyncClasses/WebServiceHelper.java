 ...
 */
//this class is use to perfrom all server related operation like get or post data on server
        ...
        if(requestCode==ConstantValues.LIKE_RESPONSE)
        {
            try {
                ...
                if (likeModels.getLikedStatus().equals("liked")) {
                    ...
                    Methods.showSnackbar(likeModels.getMessage(), (Activity) context);
//
                }else{
                    selectedPid = likeModels.getPost_id();
                ...
                try {
                    ...
                    if (bookMarkModels.getStatus()) {
                        if(bookMarkModels.getBookmark_type().equalsIgnoreCase("remove")){
                            ...
                            Methods.showSnackbar(bookMarkModels.getMessage(), (Activity) context);
