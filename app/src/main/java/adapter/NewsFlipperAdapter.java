        ...
        switch (items.get(position).getItemCount()) {
            case 1:
                ...
                holder.newsdetailwebviewclickfifth.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        callIntent(items.get(position).getItems().get(0).getDetails() + "", items.get(position).getItems().get(0).getId() + "", (ArrayList<Attachment>) items.get(position).getItems().get(0).getAttachments(), context);
                    }
                });
                ...
                holder.share_news_fifth.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        takeScreenshot(holder, items.get(position).getItems().get(0).getDetails() + "", holder.cardviewsix);
                    }
                });
            ...
            case 2:
                ...
                holder.newsdetailwebviewclickfourth.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        callIntent(items.get(position).getItems().get(1).getDetails() + "", items.get(position).getItems().get(1).getId() + "", (ArrayList<Attachment>) items.get(position).getItems().get(1).getAttachments(), context);
                    }
                });
                //click listener for share screen shot
                holder.share_news_third.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        takeScreenshot(holder, items.get(position).getItems().get(0).getDetails() + "", holder.cardfourth);
                    }
                });
                //click listener for share screen shot
                holder.share_news_fourth.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        takeScreenshot(holder, items.get(position).getItems().get(1).getDetails() + "", holder.cardfive);
                    }
                });
            ...
            case 3:
                ...
                holder.newsdetailwebviewclicksecond.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        callIntent(items.get(position).getItems().get(2).getDetails() + "", items.get(position).getItems().get(2).getId() + "", (ArrayList<Attachment>) items.get(position).getItems().get(2).getAttachments(), context);
                    }
                });
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    String responseserver = Methods.bookmarkArticleServer(context, items.get(position).getItems().get(0).getId());
                                    jsonObject = new JSONObject(responseserver);
                                    holder.bookmarked = jsonObject.getString("bookmark_status");

                                    ((Activity) context).runOnUiThread(new Runnable() {
                                        @Override
                                        public void run() {
                                            if (holder.bookmarked.equalsIgnoreCase("bookmarked")) {
...
//--------------------------------********************bookmark article end****************-----------------------------------------//
                ...
                holder.share_news.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        takeScreenshot(holder, items.get(position).getItems().get(0).getDetails() + "", holder.cardone);
                    }
                });
                ...
                holder.share_news_first.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        takeScreenshot(holder, items.get(position).getItems().get(1).getDetails() + "", holder.cardsecond);
                    }
                });
                //click listener for share screen shot
                holder.share_news_second.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        takeScreenshot(holder, items.get(position).getItems().get(2).getDetails() + "", holder.cardthird);
                    }
                });
                break;
        }
...
//        }
    ...
    public void callIntent(String url, String news_id, ArrayList<Attachment> attachments, Context context) {
        Intent intent = new Intent(context, NewsDetailWebviewActivity.class);
        Bundle bundle = new Bundle();
        bundle.putSerializable("List_attachment", attachments);
